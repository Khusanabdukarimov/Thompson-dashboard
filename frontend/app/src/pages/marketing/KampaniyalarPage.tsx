    ...
    () => [
      {
        header: "Kun",
        accessorKey: "day",
        cell: (c) => <span className="mono">{c.getValue<number>()}</span>,
      },
      {
        header: "FB sarf",
        accessorKey: "fb_budget",
        cell: (c) => (
          <span className="mono">{fmtMoney(c.getValue<number>())}</span>
        ),
      },
      ...
      {
        header: "Klik (FB+IG)",
        accessorFn: (r) => r.fb_clicks + r.ig_clicks,
        cell: (c) => (
          <span className="mono">{fmtNum(c.getValue<number>())}</span>
        ),
      },
