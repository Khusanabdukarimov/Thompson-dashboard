// Range calendar popover — ported from the Jahonschool dashboard so both
// products pick dates the same way. Self-contained: only lucide icons and
// the shared CSS theme vars.
