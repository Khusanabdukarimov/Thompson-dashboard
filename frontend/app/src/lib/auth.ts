...
export type AuthMe = { username: string; auth_enabled: boolean };
...
export async function login(password: string, username = 'admin'): Promise<{ access_token: string; username: string }> {
